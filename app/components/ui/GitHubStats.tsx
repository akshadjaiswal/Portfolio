    ...
    <div className="rounded-lg bg-portfolio-surface/30 border border-portfolio-border p-6">
      ...
      <div className="space-y-4 mb-6">
        {stars !== undefined && (
          <div className="flex items-center gap-3">
            <Star size={18} className="text-portfolio-silver" />
        ...
        {forks !== undefined && (
          <div className="flex items-center gap-3">
            <GitFork size={18} className="text-portfolio-silver" />
            <span className="text-portfolio-text">
        ...
        {primaryLanguage && (
          <div className="flex items-center gap-3">
            <Code size={18} className="text-portfolio-silver" />
            <span className="text-portfolio-text">{primaryLanguage}</span>
          </div>
        )}

        {lastUpdated && (
          <div className="flex items-center gap-3">
            <Clock size={18} className="text-portfolio-silver" />
            <span className="text-portfolio-text">
            ...
            {topLanguages.map((lang) => (
              <div key={lang.name}>
                <div className="flex items-center justify-between text-sm mb-1">
                  <span className="text-portfolio-text">{lang.name}</span>
      ...
      {repositoryUrl && (
        <a
          ...
          className="inline-flex items-center gap-2 text-sm text-portfolio-silver hover:text-portfolio-text transition-colors mt-6"
        >
